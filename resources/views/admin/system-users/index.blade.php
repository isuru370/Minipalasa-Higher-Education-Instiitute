...
@php
    ...
    $activeUsers = $systemUsers->where('is_active', 1)->count();
    $inactiveUsers = $systemUsers->where('is_active', 0)->count();
    $linkedUsers = $systemUsers->filter(fn ($u) => !empty($u->user?->name))->count();
@endphp
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="action-buttons">
                                    <a href="{{ route('admin.system-users.show', $systemUser) }}" class="action-btn view-btn" title="View">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>

                                    <a href="{{ route('admin.system-users.edit', $systemUser) }}" class="action-btn edit-btn" title="Edit">
